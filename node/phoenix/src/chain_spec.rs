...
const STAGE_PROPERTIES: &str = r#"
{
    "tokenDecimals": 18,
    "tokenSymbol": "PTN"
}"#;
const STAGE_PROTOCOL_ID: &str = "cyn";
...
pub fn stage_config() -> Result<ChainSpec, String> {
	...
	Ok(ChainSpec::from_genesis(
		...
		None,
		// Protocol ID
		Some(STAGE_PROTOCOL_ID),
		// Properties
		serde_json::from_str(STAGE_PROPERTIES).unwrap(),
		// Extensions
		None,
	))
}
...
fn stage_genesis(
	...
	const ENDOWMENT: u128 = 1000_000_000 * DOLLARS;
